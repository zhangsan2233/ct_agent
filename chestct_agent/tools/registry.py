...
TOOL_REGISTRY: dict[str, ToolSpec] = {
    ...
    for item in (
        ...
        ToolSpec(
            "qwen_slice_vqa_tool",
            "Review targeted and representative CT slices with an independent vision model.",
            requires_ct=True,
            risk="medium",
        ...
        ToolSpec(
            ...
            "Run a 3D lung-nodule candidate segmenter and component measurements.",
            requires_ct=True,
            risk="medium",
        ...
        ToolSpec(
            ...
            "Segment pleural/pericardial fluid and measure volume.",
            requires_ct=True,
            risk="medium",
            timeout_seconds=900.0,
        ),
        ToolSpec(
            ...
            "Measure CT cardiothoracic ratio from independent heart and lung masks.",
            requires_ct=True,
            risk="medium",
            optional=True,
            timeout_seconds=900.0,
        ...
        ToolSpec(
            "ct_attribution_tool",
            "Explain calibrated CT-positive labels with CT-CLIP Gradient x Token maps.",
            requires_ct=True,
            risk="medium",
            timeout_seconds=120.0,
        ),
